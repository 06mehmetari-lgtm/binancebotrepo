            ...
            <table className="w-full text-xs min-w-[800px]">
              <thead>
                <tr className="text-gray-500 border-b border-gray-800 bg-gray-900/80">
                  ...
                  <th className="text-left px-4 py-2.5">Gen</th>
              ...
              <tbody>
                {genomes.map((g, i) => (
                  <tr key={g.genome_id} className={`border-b border-gray-800/40 hover:bg-gray-800/25 transition-colors ${i === 0 ? 'bg-green-950/20' : ''}`}>
                    ...
                    <td className={`px-4 py-2.5 tabular-nums font-mono ${g.sharpe_ratio != null ? ((g.sharpe_ratio ?? 0) >= 1.5 ? 'text-green-400' : 'text-gray-400') : 'text-gray-600'}`}>
